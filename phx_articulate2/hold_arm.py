'''this file is a modification of pic_coord_from_crop that simply holds the arm in a still position
tha is ideal for data collection on the esp32s3 sense'''
...
# check arm position here for esp capture
    ...
    print(f"Holding intermediate position: {intermediate_pos}")
    print(f"Theta0_4 = {theta0_4}")
